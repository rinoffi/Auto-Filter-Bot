...
BOT_TOKEN = environ.get('BOT_TOKEN', "8249947123:AAGl0bEb8emFqoGD5YkYKx-3MmaAjh87FTg")

CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://files.catbox.moe/es30mo.jpg')).split() 
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002583830624') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002583830624') 
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sivanesh:9488128178siva@cluster02.uyxp6bz.mongodb.net/?retryWrites=true&w=majority&appName=cluster02")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster02")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'clustor02')

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "False"), False) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://vihara4360:waldernun@cluster0.xueft5v.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002853893090'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002690503523'))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+mz8geE-1els2OTY1') 
